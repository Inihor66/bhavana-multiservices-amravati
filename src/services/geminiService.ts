...
export async function getAiResponse(message: string, language: string, hasSentPhoto: boolean) {
  try {
    ...
    return response.text || "Thank you for your message! Our team is processing your request and will get back to you shortly. For urgent matters, please call 9881345984.";
  } catch (error) {
